...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({this.user, this.ridingRequestId});
              ...
              return Expanded(
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        final bool isMe =
                            message.sender.name == "From RidingClient"
                                ? true
                                : false;
...
// hm agya krta ha isa
  void chattMessages(
    ...
    if (RiderHomeScreen.hubConnection != null) {
      RiderHomeScreen.hubConnection.invoke("ChattMessages", args: [
        "${Commons.riderEmail}",
        "${Commons.riderPhoneNO}",
        "{}",
        "RidingClient",
        ...
        print("------------------ Send Message to Driver Error ---------- $e");
      });
    } else {
      print("====================Connection is Nulll=================");
    }
    _messageController.clear();
