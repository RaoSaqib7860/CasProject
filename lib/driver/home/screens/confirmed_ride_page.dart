...
DriverAllRidingRequest driverAllRidingRequest;
...
class DriverConfirmRide extends StatefulWidget {
  ...
  const DriverConfirmRide({this.model, this.rideList, this.riderequestID});
...
class _DriverConfirmRideState extends State<DriverConfirmRide> {
  ...
  getCurrentModel(List<DriverAllRidingRequest> list) {
    ...
    for (int i = 0; i < list.length; i++) {
      if (list[i].myId == list[i].acceptDriverId) {
        if (list[i].requestStatus == 2 || list[i].requestStatus == 4) {
          modelFound = true;
          model = list[i];
        }
      }
  ...
  void initState() {
    ...
    _api.getDriverAllRidingList(<String, dynamic>{
      ...
      isLoading = false;
      setState(() {
        driverAllRidingRequest = getCurrentModel(value.data);
      });
    });
          ...
          : Container(
              ...
              child: ListView(
                children: [
                  ...
                  modelFound == false
                      ? Container(
                          // child: Center(child: Text("No Ride Request is Accepted")),
                          )
                      : Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                width: width * 0.73,
                                                child: AutoSizeText(
                                                  "${driverAllRidingRequest.fromAddress}",
                                                  maxLines: 2,
                                                  style: TextStyle(
                                                      color: Colors.black),
                                                ),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  width: width * 0.73,
                                                  child: AutoSizeText(
                                                    "${driverAllRidingRequest.toAddress}",
                                                    maxLines: 2,
                                                    style: TextStyle(
                                                        color: Colors.black),
                                                  ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ListTile(
                                      title: Text(
                                        '${driverAllRidingRequest.ridingClientName}',
                                      ),
                                      leading: Icon(
                                        Icons.person,
                                        color: Colors.blue,
                                  ...
                                  Container(
                                    ...
                                    child: ListTile(
                                      title: Text(
                                        '${driverAllRidingRequest.ridingClientPhoneNumber}',
                                      ),
                                      leading: Icon(
                                        Icons.phone,
                                        color: Colors.blue,
                                  ...
                                  Container(
                                    ...
                                    child: ListTile(
                                      title: Text(
                                        '${Utils.getTimeinformat(driverAllRidingRequest.requestTimeDate)}',
                                      ),
                                      leading: Icon(
                                        Icons.timer,
                                        color: Colors.blue,
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: ListTile(
                                        title: Text(
                                          '${Utils.getDateFormat(driverAllRidingRequest.requestTimeDate)}',
                                        ),
                                        leading: Icon(
                                  ...
                                  ///
                                  ///
                                  driverAllRidingRequest.penaltyAmount != null
                                      ? Padding(
                                          padding: EdgeInsets.only(
                                              top: height * 0.02),
                                          child: Container(
                                            ...
                                            child: ListTile(
                                              title: Text(
                                                '${driverAllRidingRequest.penaltyAmount == null ? '0.0' : driverAllRidingRequest.penaltyAmount} Rs',
                                              ),
                                              leading: Image.asset(
                                                "images/penalty.png",
                                                color: Colors.blue,
                  ...
                  modelFound == false
                      ...
                      : Padding(
                          ...
                          //
                          child: Container(
                            child: driverAllRidingRequest.requestStatus == 1
                                ? InkWell(
                                    onTap: () {
                                ...
                                : driverAllRidingRequest.requestStatus == 2
                                    ? Column(
                                        mainAxisAlignment:
...
//
                                    ...
                                    : driverAllRidingRequest.requestStatus == 4
                                        ? InkWell(
                                            onTap: () {
                                              startRide();
                                              Navigator.push(context,
