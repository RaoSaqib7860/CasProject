...
import 'driver_image.dart';

import 'driver_image.dart';

// ignore: must_be_immutable
class DriverVehicleInfoPage extends StatefulWidget {
  String phoneNo;
  String password;
  @override
  _DriverVehicleInfoPageState createState() => _DriverVehicleInfoPageState();

  DriverVehicleInfoPage({this.password, this.phoneNo});
}

class _DriverVehicleInfoPageState extends State<DriverVehicleInfoPage>
