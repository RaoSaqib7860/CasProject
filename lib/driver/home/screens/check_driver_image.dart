...
class CheckDriverImageUploadPage extends StatefulWidget {
  String phoneNo;
  String password;
  CheckDriverImageUploadPage({
    Key key,
    this.phoneNo,
    this.password,
  }) : super(key: key);
...
class _DriverImageUploadPageState extends State<CheckDriverImageUploadPage> {
  var height, width;
